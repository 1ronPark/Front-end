...
const ProjectInfoCard = ({ user, name, date, location }: Props) => {
  ...
  <div className="flex flex-col gap-6 w-full">
    <div className="flex">
      <div className="title-medium text-[#49454E] min-w-[160px]">
        프로젝트 명
      </div>
      <span className="title-medium text-[#1D1B20] ml-6">lightup</span>
    </div>
    ...
    <div className="flex">
      <div className="title-medium text-[#49454E] min-w-[160px]">위치</div>
      <span className="body-medium ml-6">{location}</span>
    </div>
    <div className="flex">
      <div className="title-medium text-[#49454E] min-w-[160px]">우대 MBTI</div>
      <span className="body-medium ml-6">ISFJ, ENTJ</span>
    </div>
    <div className="flex">
      <div className="title-medium text-[#49454E] min-w-[160px]">모집 파트</div>
      ...
      <div className="flex gap-4 justify-center mt-4 mb-4">
        <button className="w-[200px] h-[56px] flex items-center justify-center gap-2.5 rounded-[16px] bg-[#F8F1FA] shadow-[0px_2px_6px_2px_rgba(0,0,0,0.15),_0px_1px_2px_0px_rgba(0,0,0,0.3)] cursor-pointer">
          <img src={ic_send} alt="send icon" className="w-4 h-4" />
          <p className="title-medium text-[#68548E]">지원하기</p>
        </button>

        <button className="w-[200px] h-[56px] flex items-center justify-center gap-2.5 border border-[#CBC4CF] rounded-[16px]
         bg-white text-[#49454E] shadow-[0px_2px_6px_2px_rgba(0,0,0,0.15),_0px_1px_2px_0px_rgba(0,0,0,0.3)] cursor-pointer">
          <Heart size={20} />
